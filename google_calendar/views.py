...
def GoogleCalendarRedirectView(request):
    ...
    try:
        ...
        # Upcoming Events
        upcoming_events_result = service.events().list(calendarId='primary', timeMin=now,
        ...
        if not all_events:
            ...
            final_list = [
                {'Upcoming Events ': upcoming_events_list, 'All Events ': all_events_list}]
